...
広告チャネル戦略。「どのチャネルにいくら出すか」を毎回同じ手順で決めるためのドキュメント（前半は汎用フレーム、後半が今回の適用と合意用の決定シート）。

- ドキュメント: `ad-channel-strategy/README.md`
- 内容: チャネルを決める5つの問い/チャネル台帳（Meta・Peatix・LINE・Yahoo）/今回の予算配分/Meta広告ガイドとの差分/MTG決定シート/記録テンプレート
- 8/31回の結論: **Peatix掲載（無料・成果報酬）＋ Peatix上位掲載 約3,000円 ＋ Meta広告 7,000円（女性1セット）＝ 約10,000円**
